    ...
    <div className="flex min-h-[80vh] flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-md sm:p-8 transition-colors">
        ...
        <div className="rounded-lg bg-slate-50 dark:bg-slate-800/50 p-3.5 text-xs text-slate-600 dark:text-slate-300 border border-slate-200 dark:border-slate-850">
          <p className="font-semibold text-slate-700 dark:text-slate-200">Presentation Login Mode:</p>
          <p className="mt-1">Enter any valid email and a 6+ character password to continue (e.g., <code className="bg-slate-200 dark:bg-slate-700 px-1 rounded text-slate-900 dark:text-slate-100">demo@example.com</code> / <code className="bg-slate-200 dark:bg-slate-700 px-1 rounded text-slate-900 dark:text-slate-100">123456</code>).</p>
        </div>
        ...
        <form className="mt-6 space-y-5" onSubmit={handleSubmit} noValidate>
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className={`block w-full rounded-lg border px-3 py-2 text-sm shadow-sm transition placeholder:text-slate-400 bg-white dark:bg-slate-800 border-slate-300 dark:border-slate-700 text-slate-900 dark:text-white focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 focus:outline-none ${
                errors.email ? 'border-red-500 focus:border-red-500 focus:ring-red-500 dark:border-red-500 dark:focus:ring-red-500' : ''
              }`}
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className={`block w-full rounded-lg border px-3 py-2 text-sm shadow-sm transition placeholder:text-slate-400 bg-white dark:bg-slate-800 border-slate-300 dark:border-slate-700 text-slate-900 dark:text-white focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 focus:outline-none ${
                errors.password ? 'border-red-500 focus:border-red-500 focus:ring-red-500 dark:border-red-500 dark:focus:ring-red-500' : ''
              }`}
              placeholder="••••••••"
